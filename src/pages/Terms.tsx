    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 container mx-auto px-4 py-12">
        <Card className="max-w-4xl mx-auto">
          <CardHeader>
            <CardTitle className="text-3xl text-center text-yellow-400">Conditions d'utilisation</CardTitle>
          ...
          <CardContent className="prose prose-lg max-w-none space-y-6">
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-yellow-400">1. Acceptation des conditions</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-yellow-400">2. Description du service</h2>
              <p className="text-white leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-yellow-400">3. Conditions d'accès</h2>
              <p className="text-white leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-yellow-400">4. Règles de conduite</h2>
              <p className="text-white leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-yellow-400">5. Vie privée et données</h2>
              <p className="text-white leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-yellow-400">6. Responsabilité</h2>
              <p className="text-white leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-yellow-400">7. Contenu des annonces</h2>
              <p className="text-white leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-yellow-400">8. Suspension et résiliation</h2>
              <p className="text-white leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-yellow-400">9. Modifications</h2>
              <p className="text-white leading-relaxed">
            ...
            <section>
              ...
              <p className="text-white leading-relaxed">
                ...
                <span className="font-medium text-yellow-400"> contact@yamo.fr</span>
              </p>
            </section>
