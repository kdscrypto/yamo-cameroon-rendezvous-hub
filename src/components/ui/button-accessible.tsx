...
export interface ButtonAccessibleProps
...
const ButtonAccessible = React.forwardRef<HTMLButtonElement, ButtonAccessibleProps>(
  ({ 
    className, 
    variant, 
    size, 
    ...
    const { accessibilityProps } = useAccessibility({
      ariaLabel: loading ? loadingText : ariaLabel,
      ariaDescribedBy,
    });
...
export { ButtonAccessible, buttonVariants }
